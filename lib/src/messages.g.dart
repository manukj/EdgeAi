...
class EdgeGenAIHostApi {
  ...
  Future<EdgeGenAIAvailability> checkAvailability(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.checkAvailability$pigeonVar_messageChannelSuffix';
  ...
  Future<void> resetConversation(String sessionId) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.resetConversation$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> summarize(String text) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.summarize$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> proofread(String text) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.proofread$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> rewrite(String text, EdgeGenAIRewriteStyle style) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.rewrite$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> describeImage(Uint8List imageBytes) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.describeImage$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
///
/// Returns a broadcast [Stream] of events from the `promptDownloadProgress` event channel.
///
...
Stream<EdgeGenAIDownloadProgress> promptDownloadProgress({
  ...
  final EventChannel promptDownloadProgressChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.promptDownloadProgress$instanceName',
    pigeonMethodCodec,
  );
...
///
/// Returns a broadcast [Stream] of events from the `summarizationDownloadProgress` event channel.
///
/// Each call to this method creates a new [EventChannel], so it should
/// not be called multiple times for the same `instanceName`. To deliver
/// events to multiple listeners, call this method once and listen to the
...
Stream<EdgeGenAIDownloadProgress> summarizationDownloadProgress({
  ...
  final EventChannel summarizationDownloadProgressChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.summarizationDownloadProgress$instanceName',
    pigeonMethodCodec,
  );
...
///
/// Returns a broadcast [Stream] of events from the `proofreadingDownloadProgress` event channel.
///
/// Each call to this method creates a new [EventChannel], so it should
/// not be called multiple times for the same `instanceName`. To deliver
/// events to multiple listeners, call this method once and listen to the
...
Stream<EdgeGenAIDownloadProgress> proofreadingDownloadProgress({
  ...
  final EventChannel proofreadingDownloadProgressChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.proofreadingDownloadProgress$instanceName',
    pigeonMethodCodec,
  );
...
///
/// Returns a broadcast [Stream] of events from the `rewritingDownloadProgress` event channel.
///
/// Each call to this method creates a new [EventChannel], so it should
/// not be called multiple times for the same `instanceName`. To deliver
/// events to multiple listeners, call this method once and listen to the
...
Stream<EdgeGenAIDownloadProgress> rewritingDownloadProgress({
  ...
  final EventChannel rewritingDownloadProgressChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.rewritingDownloadProgress$instanceName',
    pigeonMethodCodec,
  );
...
///
/// Returns a broadcast [Stream] of events from the `imageDescriptionDownloadProgress` event channel.
///
/// Each call to this method creates a new [EventChannel], so it should
/// not be called multiple times for the same `instanceName`. To deliver
/// events to multiple listeners, call this method once and listen to the
...
Stream<EdgeGenAIDownloadProgress> imageDescriptionDownloadProgress({
  ...
  final EventChannel imageDescriptionDownloadProgressChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.imageDescriptionDownloadProgress$instanceName',
    pigeonMethodCodec,
  );
...
///
/// Returns a broadcast [Stream] of events from the `generateContentChunk` event channel.
///
/// Each call to this method creates a new [EventChannel], so it should
/// not be called multiple times for the same `instanceName`. To deliver
/// events to multiple listeners, call this method once and listen to the
...
Stream<String> generateContentChunk({String instanceName = ''}) {
  ...
  final EventChannel generateContentChunkChannel = EventChannel(
    'dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.generateContentChunk$instanceName',
    pigeonMethodCodec,
  );
