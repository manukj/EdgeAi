...
class EdgeGenAIHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: EdgeGenAIHostApi?, messageChannelSuffix: String = "") {
    ...
    let checkAvailabilityChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.checkAvailability\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Event channels can't carry parameters, so callers must invoke this
    /// immediately before listening to the `generateContentChunk` stream.
    let startGenerateContentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.startGenerateContent\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Clears the conversation history remembered for [sessionId] so that
    /// instance's next `generateContent` call starts a fresh conversation.
    let resetConversationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.resetConversation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Summarizes [text] and returns the summary.
    let summarizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.summarize\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Proofreads [text] and returns the corrected text.
    let proofreadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.proofread\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Rewrites [text] in the given [style] and returns the rewritten text.
    let rewriteChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.rewrite\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Describes the image encoded in [imageBytes] (for example PNG or JPEG
    /// bytes) and returns the description.
    let describeImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.describeImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class EdgeGenAIToolExecutorApi: EdgeGenAIToolExecutorApiProtocol {
  ...
  /// tool's result for the model to continue generating with.
  func callTool(sessionId sessionIdArg: String, toolName toolNameArg: String, argumentsJson argumentsJsonArg: String, completion: @escaping (Result<String, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIToolExecutorApi.callTool\(messageChannelSuffix)"
...
class PromptDownloadProgressStreamHandler: PigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.promptDownloadProgress"
...
class SummarizationDownloadProgressStreamHandler: PigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.summarizationDownloadProgress"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = PigeonStreamHandler<EdgeGenAIDownloadProgress>(wrapper: streamHandler)
...
class ProofreadingDownloadProgressStreamHandler: PigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.proofreadingDownloadProgress"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = PigeonStreamHandler<EdgeGenAIDownloadProgress>(wrapper: streamHandler)
...
class RewritingDownloadProgressStreamHandler: PigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.rewritingDownloadProgress"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = PigeonStreamHandler<EdgeGenAIDownloadProgress>(wrapper: streamHandler)
...
class ImageDescriptionDownloadProgressStreamHandler: PigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.imageDescriptionDownloadProgress"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = PigeonStreamHandler<EdgeGenAIDownloadProgress>(wrapper: streamHandler)
...
class GenerateContentChunkStreamHandler: PigeonEventChannelWrapper<String> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.generateContentChunk"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
