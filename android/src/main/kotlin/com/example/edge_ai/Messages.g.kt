...
interface EdgeGenAIHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: EdgeGenAIHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.checkAvailability$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.startGenerateContent$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.resetConversation$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val sessionIdArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.summarize$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.proofread$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val textArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.rewrite$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val textArg = args[0] as String
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.edge_ai.EdgeGenAIHostApi.describeImage$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
...
abstract class PromptDownloadProgressStreamHandler : MessagesPigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: PromptDownloadProgressStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.promptDownloadProgress"
...
abstract class SummarizationDownloadProgressStreamHandler : MessagesPigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: SummarizationDownloadProgressStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.summarizationDownloadProgress"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = MessagesPigeonStreamHandler<EdgeGenAIDownloadProgress>(streamHandler)
...
abstract class ProofreadingDownloadProgressStreamHandler : MessagesPigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: ProofreadingDownloadProgressStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.proofreadingDownloadProgress"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = MessagesPigeonStreamHandler<EdgeGenAIDownloadProgress>(streamHandler)
...
abstract class RewritingDownloadProgressStreamHandler : MessagesPigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: RewritingDownloadProgressStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.rewritingDownloadProgress"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = MessagesPigeonStreamHandler<EdgeGenAIDownloadProgress>(streamHandler)
...
abstract class ImageDescriptionDownloadProgressStreamHandler : MessagesPigeonEventChannelWrapper<EdgeGenAIDownloadProgress> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: ImageDescriptionDownloadProgressStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.imageDescriptionDownloadProgress"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = MessagesPigeonStreamHandler<EdgeGenAIDownloadProgress>(streamHandler)
...
abstract class GenerateContentChunkStreamHandler : MessagesPigeonEventChannelWrapper<String> {
  companion object {
    fun register(messenger: BinaryMessenger, streamHandler: GenerateContentChunkStreamHandler, instanceName: String = "") {
      var channelName: String = "dev.flutter.pigeon.edge_ai.EdgeGenAIEventApi.generateContentChunk"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
